...
static std::vector<std::string> s_Preset_print_options{
    ...
    "fs_surface_paint_only",
    "fs_painted_zone_extra_perimeters",
...
static std::vector<std::string> s_Preset_filament_options{
    ...
    "filament_type", "filament_soluble", "filament_is_support", "filament_transmission_distance", "filament_full_spectrum_material_id",
    "filament_max_volumetric_speed", "filament_flow_ratio", "filament_density", "filament_cost", "filament_minimal_purge_on_wipe_tower",
    ...
    "slow_down_for_layer_cooling", "fan_min_speed", "fan_max_speed", "enable_overhang_bridge_fan", "overhang_fan_speed",
    "overhang_fan_threshold", "close_fan_the_first_x_layers", "full_fan_speed_layer", "fan_cooling_layer_time", "slow_down_layer_time",
    "slow_down_min_speed", "filament_start_gcode", "filament_end_gcode",
    // exhaust fan control
    ...
    "filament_notes" /*,"filament_seam_gap"*/, "ironing_fan_speed", "filament_loading_speed", "filament_loading_speed_start",
    "filament_unloading_speed", "filament_unloading_speed_start", "filament_toolchange_delay", "filament_cooling_moves",
    "filament_stamping_loading_speed", "filament_stamping_distance", "filament_cooling_initial_speed", "filament_cooling_final_speed",
    "filament_ramming_parameters", "filament_multitool_ramming", "filament_multitool_ramming_volume", "filament_multitool_ramming_flow",
    "activate_chamber_temp_control", "filament_long_retractions_when_cut", "filament_retraction_distances_when_cut", "idle_temperature",
    "filament_tower_ironing_area", "filament_flow_support"};
